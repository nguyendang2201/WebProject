    ...
    <div class="shoes-grid">
        ...
        <div style="box-shadow: 10px 10px 5px #888888;"class="view-adjust banner-matter">
            <div class="col-md-5 banner-bag">
                ...
                <img style="margin-top: 60px" class="img-responsive " src="<%=currentProduct.getInfo()%>" alt=" " />
                <% } else {%>
                <img style="margin-top: 60px" class="img-responsive " src="images/<%=productId%>.jpg" alt=" " />
                <%}%>
